...
const esMessages = {
  ...
  "aura.live.ready": "Aura Live lista",
  "aura.live.active": "Aura Live activa",
  "aura.live.unavailable": "Aura Live no disponible",
  ...
  "chat.micDetecting": "Preparando micrófono",
  ...
  "chat.voiceEntryHint":
    "La voz está lista. Pulsa el micrófono cuando quieras; IAURA no lo activará sin tu permiso.",
  ...
  "branding.eyebrow": "SISTEMA DE MARCA",
  "branding.subtitle":
    "Convierte la esencia de tu empresa en una identidad visual coherente, reconocible y lista para crecer.",
  "branding.close": "Cerrar estudio de marca",
  "branding.foundationTitle": "Fundación",
  "branding.foundationHint":
    "Define el núcleo verbal y emocional que guiará cada decisión de tu marca.",
  "branding.personality": "Personalidad",
  "branding.personalityHint": "Elige hasta tres",
  "branding.personality.futuristic": "Futurista",
  "branding.personality.human": "Humana",
  "branding.personality.premium": "Premium",
  "branding.personality.bold": "Audaz",
  "branding.personality.serene": "Serena",
  "branding.personality.playful": "Dinámica",
  "branding.typography": "Dirección tipográfica",
  "branding.typography.modern": "Moderna",
  "branding.typography.editorial": "Editorial",
  "branding.typography.technical": "Técnica",
  "branding.logoTitle": "Logo e íconos",
  "branding.logoHint":
    "Construye un símbolo reconocible y comprueba cómo vive desde un favicon hasta el ícono de tu producto.",
  "branding.logoSymbolLabel": "Concepto del símbolo",
  "branding.logoContainerLabel": "Contenedor",
  "branding.logoWeightLabel": "Peso visual",
  "branding.logo.symbol.spark": "Destello",
  "branding.logo.symbol.orbit": "Órbita",
  "branding.logo.symbol.monogram": "Monograma",
  "branding.logo.symbol.portal": "Portal",
  "branding.logo.container.squircle": "Cápsula",
  "branding.logo.container.circle": "Círculo",
  "branding.logo.container.none": "Libre",
  "branding.logo.weight.light": "Ligero",
  "branding.logo.weight.regular": "Medio",
  "branding.logo.weight.bold": "Fuerte",
  "branding.logoUsageTitle": "Sistema adaptable",
  "branding.logoAppIcon": "App icon",
  "branding.logoFavicon": "Favicon",
  "branding.logoWordmark": "Firma horizontal",
  "branding.paletteTitle": "Universo visual",
  "branding.paletteHint":
    "Elige un sistema o crea una paleta única para tu empresa.",
  "branding.palette.primary": "Primario",
  "branding.palette.secondary": "Secundario",
  "branding.palette.accent": "Acento",
  "branding.palette.background": "Fondo",
  "branding.palette.text": "Texto",
  "branding.copyPalette": "Copiar paleta",
  "branding.copied": "Paleta copiada",
  "branding.previewTitle": "Vista de identidad",
  "branding.previewCta": "Comenzar",
  "branding.save": "Guardar identidad",
  "branding.saved": "Identidad guardada",
  "branding.unsaved": "Cambios sin guardar",
...
const enMessages: Record<MessageKey, string> = {
  ...
  "aura.live.ready": "Aura Live ready",
  "aura.live.active": "Aura Live active",
  "aura.live.unavailable": "Aura Live unavailable",
  ...
  "chat.sendFailed": "The message could not be sent. Try again.",
  "chat.micStart": "Talk to IAURA",
  "chat.micDetecting": "Preparing microphone",
  ...
  "chat.voiceEntryHint":
    "Voice is ready. Press the microphone when you choose; IAURA will not activate it without your permission.",
  "chat.voiceUnavailable":
  ...
  "branding.eyebrow": "BRAND SYSTEM",
  "branding.subtitle":
    "Turn your company’s essence into a coherent, recognizable visual identity built to grow.",
  "branding.close": "Close branding studio",
  "branding.foundationTitle": "Foundation",
  "branding.foundationHint":
    "Define the verbal and emotional core that will guide every brand decision.",
  "branding.personality": "Personality",
  "branding.personalityHint": "Choose up to three",
  "branding.personality.futuristic": "Futuristic",
  "branding.personality.human": "Human",
  "branding.personality.premium": "Premium",
  "branding.personality.bold": "Bold",
  "branding.personality.serene": "Serene",
  "branding.personality.playful": "Playful",
  "branding.typography": "Typography direction",
  "branding.typography.modern": "Modern",
  "branding.typography.editorial": "Editorial",
  "branding.typography.technical": "Technical",
  "branding.logoTitle": "Logo and icons",
  "branding.logoHint":
    "Build a recognizable symbol and see how it lives from a favicon to your product icon.",
  "branding.logoSymbolLabel": "Symbol concept",
  "branding.logoContainerLabel": "Container",
  "branding.logoWeightLabel": "Visual weight",
  "branding.logo.symbol.spark": "Spark",
  "branding.logo.symbol.orbit": "Orbit",
  "branding.logo.symbol.monogram": "Monogram",
  "branding.logo.symbol.portal": "Portal",
  "branding.logo.container.squircle": "Squircle",
  "branding.logo.container.circle": "Circle",
  "branding.logo.container.none": "Freeform",
  "branding.logo.weight.light": "Light",
  "branding.logo.weight.regular": "Regular",
  "branding.logo.weight.bold": "Bold",
  "branding.logoUsageTitle": "Adaptive system",
  "branding.logoAppIcon": "App icon",
  "branding.logoFavicon": "Favicon",
  "branding.logoWordmark": "Horizontal lockup",
  "branding.paletteTitle": "Visual universe",
  "branding.paletteHint":
    "Choose a system or create a unique palette for your company.",
  "branding.palette.primary": "Primary",
  "branding.palette.secondary": "Secondary",
  "branding.palette.accent": "Accent",
  "branding.palette.background": "Background",
  "branding.palette.text": "Text",
  "branding.copyPalette": "Copy palette",
  "branding.copied": "Palette copied",
  "branding.previewTitle": "Identity preview",
  "branding.previewCta": "Get started",
  "branding.save": "Save identity",
  "branding.saved": "Identity saved",
...
const ptMessages: Record<MessageKey, string> = {
  ...
  "aura.live.ready": "Aura Live pronta",
  "aura.live.active": "Aura Live ativa",
  "aura.live.unavailable": "Aura Live indisponível",
  ...
  "chat.sendFailed": "Não foi possível enviar. Tente novamente.",
  "chat.micStart": "Falar com IAURA",
  "chat.micDetecting": "Preparando microfone",
  ...
  "chat.voiceEntryHint":
    "A voz está pronta. Toque no microfone quando quiser; a IAURA não o ativará sem sua permissão.",
  "chat.voiceUnavailable":
  ...
  "branding.eyebrow": "SISTEMA DE MARCA",
  "branding.subtitle":
    "Transforme a essência da sua empresa em uma identidade visual coerente, reconhecível e pronta para crescer.",
  "branding.close": "Fechar estúdio de marca",
  "branding.foundationTitle": "Fundação",
  "branding.foundationHint":
    "Defina o núcleo verbal e emocional que guiará cada decisão da marca.",
  "branding.personality": "Personalidade",
  "branding.personalityHint": "Escolha até três",
  "branding.personality.futuristic": "Futurista",
  "branding.personality.human": "Humana",
  "branding.personality.premium": "Premium",
  "branding.personality.bold": "Ousada",
  "branding.personality.serene": "Serena",
  "branding.personality.playful": "Dinâmica",
  "branding.typography": "Direção tipográfica",
  "branding.typography.modern": "Moderna",
  "branding.typography.editorial": "Editorial",
  "branding.typography.technical": "Técnica",
  "branding.logoTitle": "Logo e ícones",
  "branding.logoHint":
    "Crie um símbolo reconhecível e veja como ele funciona do favicon ao ícone do produto.",
  "branding.logoSymbolLabel": "Conceito do símbolo",
  "branding.logoContainerLabel": "Contêiner",
  "branding.logoWeightLabel": "Peso visual",
  "branding.logo.symbol.spark": "Brilho",
  "branding.logo.symbol.orbit": "Órbita",
  "branding.logo.symbol.monogram": "Monograma",
  "branding.logo.symbol.portal": "Portal",
  "branding.logo.container.squircle": "Cápsula",
  "branding.logo.container.circle": "Círculo",
  "branding.logo.container.none": "Livre",
  "branding.logo.weight.light": "Leve",
  "branding.logo.weight.regular": "Médio",
  "branding.logo.weight.bold": "Forte",
  "branding.logoUsageTitle": "Sistema adaptável",
  "branding.logoAppIcon": "Ícone do app",
  "branding.logoFavicon": "Favicon",
  "branding.logoWordmark": "Assinatura horizontal",
  "branding.paletteTitle": "Universo visual",
  "branding.paletteHint":
    "Escolha um sistema ou crie uma paleta única para sua empresa.",
  "branding.palette.primary": "Primária",
  "branding.palette.secondary": "Secundária",
  "branding.palette.accent": "Destaque",
  "branding.palette.background": "Fundo",
  "branding.palette.text": "Texto",
  "branding.copyPalette": "Copiar paleta",
  "branding.copied": "Paleta copiada",
  "branding.previewTitle": "Prévia da identidade",
  "branding.previewCta": "Começar",
  "branding.save": "Salvar identidade",
  "branding.saved": "Identidade salva",
  "branding.unsaved": "Alterações não salvas",
...
const frMessages: Record<MessageKey, string> = {
  ...
  "aura.live.ready": "Aura Live prête",
  "aura.live.active": "Aura Live active",
  "aura.live.unavailable": "Aura Live indisponible",
  ...
  "chat.sendFailed": "Le message n’a pas pu être envoyé. Réessayez.",
  "chat.micStart": "Parler à IAURA",
  "chat.micDetecting": "Préparation du microphone",
  ...
  "chat.voiceEntryHint":
    "La voix est prête. Activez le microphone quand vous le souhaitez ; IAURA ne le fera pas sans votre autorisation.",
  "chat.voiceUnavailable":
  ...
  "branding.eyebrow": "SYSTÈME DE MARQUE",
  "branding.subtitle":
    "Transformez l’essence de votre entreprise en une identité visuelle cohérente, reconnaissable et conçue pour grandir.",
  "branding.close": "Fermer le studio de marque",
  "branding.foundationTitle": "Fondation",
  "branding.foundationHint":
    "Définissez le cœur verbal et émotionnel qui guidera chaque décision de marque.",
  "branding.personality": "Personnalité",
  "branding.personalityHint": "Choisissez-en trois",
  "branding.personality.futuristic": "Futuriste",
  "branding.personality.human": "Humaine",
  "branding.personality.premium": "Premium",
  "branding.personality.bold": "Audacieuse",
  "branding.personality.serene": "Sereine",
  "branding.personality.playful": "Dynamique",
  "branding.typography": "Direction typographique",
  "branding.typography.modern": "Moderne",
  "branding.typography.editorial": "Éditoriale",
  "branding.typography.technical": "Technique",
  "branding.logoTitle": "Logo et icônes",
  "branding.logoHint":
    "Créez un symbole reconnaissable et voyez comment il s’adapte du favicon à l’icône du produit.",
  "branding.logoSymbolLabel": "Concept du symbole",
  "branding.logoContainerLabel": "Conteneur",
  "branding.logoWeightLabel": "Poids visuel",
  "branding.logo.symbol.spark": "Étincelle",
  "branding.logo.symbol.orbit": "Orbite",
  "branding.logo.symbol.monogram": "Monogramme",
  "branding.logo.symbol.portal": "Portail",
  "branding.logo.container.squircle": "Capsule",
  "branding.logo.container.circle": "Cercle",
  "branding.logo.container.none": "Libre",
  "branding.logo.weight.light": "Léger",
  "branding.logo.weight.regular": "Moyen",
  "branding.logo.weight.bold": "Fort",
  "branding.logoUsageTitle": "Système adaptatif",
  "branding.logoAppIcon": "Icône d’app",
  "branding.logoFavicon": "Favicon",
  "branding.logoWordmark": "Signature horizontale",
  "branding.paletteTitle": "Univers visuel",
  "branding.paletteHint":
    "Choisissez un système ou créez une palette unique pour votre entreprise.",
  "branding.palette.primary": "Primaire",
  "branding.palette.secondary": "Secondaire",
  "branding.palette.accent": "Accent",
  "branding.palette.background": "Fond",
  "branding.palette.text": "Texte",
  "branding.copyPalette": "Copier la palette",
  "branding.copied": "Palette copiée",
  "branding.previewTitle": "Aperçu de l’identité",
  "branding.previewCta": "Commencer",
  "branding.save": "Enregistrer l’identité",
  "branding.saved": "Identité enregistrée",
  "branding.unsaved": "Modifications non enregistrées",
  "brand.identityMissionLabel": "Mission",
