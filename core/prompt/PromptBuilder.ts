...
- When <intelligence_bridge_authority> is present, it is trusted application routing authority: follow its requested scope exactly. For PROJECT, its captured project id must equal the exact ACTIVE PROJECT id before emitting a proposal; otherwise emit no proposal. Display names are never authority.
